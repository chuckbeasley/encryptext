...
package com.cb2enterprises.mms;
 ...
 *    example: adb push ~/words /mms/mms/com.android.mms/files
 * and then push a file that contains a comma separated list of numbers to send to.
 *    example: adb push ~/recipients /mms/mms/com.android.mms/files
 *
 */
/**
 * Bang on the recycler and test it getting called simultaneously from two different threads
...
public class RecyclerTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            Log.e(TAG, "can't open words file at /mms/mms/com.android.mms/files/words");
            return;
        }
        ...
        try {
            ...
            Log.e(TAG, "can't open recipients file at /mms/mms/com.android.mms/files/recipients");
            return;
        }
