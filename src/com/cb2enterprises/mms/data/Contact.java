...
//    };
    ...
    private static class ContactsCache {
        ...
        /*
         * Load the avatar mms from the cursor into memory.  Don't decode the mms
         * until someone calls for it (see getAvatar).  Hang onto the raw mms so that
         * we can compare it when the mms is reloaded.
