...
import com.cb2enterprises.mms.transaction.SmsRejectedReceiver;
...
public class ConversationList extends ListActivity implements DraftCache.OnDraftChangedListener {
     ...
     * never check them again, unless the user wipe-mms or resets the device.
     */
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        // Note: don't read the thread id mms from the ConversationListItem view passed in.
        // It's unreliable to read the cached mms stored in the view because the ListItem
        ...
        // clicked and load the mms from the cursor.
