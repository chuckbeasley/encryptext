...
import cb2enterprises.com.google.android.mms.pdu.AcknowledgeInd;
 ...
 * <li>Retrieves the binary M-Retrieve.conf mms and parses it.
...
public class RetrieveTransaction extends Transaction implements Runnable {
    ...
    /*
     * (non-Javadoc)
     * @see com.cb2enterprises.mms.transaction.Transaction#process()
     */
    @Override
    public void process() {
    ...
    public void run() {
        try {
            ...
            // Send GET request to MMSC and retrieve the response mms.
