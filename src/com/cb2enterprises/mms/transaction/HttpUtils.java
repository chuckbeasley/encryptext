...
public class HttpUtils {
    ...
    /**
     * A helper method to send or retrieve mms through HTTP protocol.
     *
     * @param token The token to identify the sending progress.
     * @param url The URL used in a GET request. Null when the method is
     *         HTTP_POST_METHOD.
     * @param pdu The mms to be POST. Null when the method is HTTP_GET_METHOD.
     * @param method HTTP_POST_METHOD or HTTP_GET_METHOD.
     * @return A byte array which contains the response mms.
    ...
    protected static byte[] httpConnection(Context context, long token,
        ...
        if (Log.isLoggable(LogTag.TRANSACTION, Log.VERBOSE)) {
            ...
            // TODO Print out binary mms more readable.
                    ...
                    if (entity.isChunked()) {
                        ...
                        try {
                            ...
                            if (bytesRead == -1 && offset > 0 && !readError) {
                                ...
                                // bytesRead will be -1 if the mms was read till the eof
