 ...
 * capturing pictures and videos and storing the mms in a file in the messaging app.
 */
public class TempFileProvider extends ContentProvider {
    ...
    public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
        ...
        // wants a file descriptor to write image mms to.
     ...
     * file won't overwrite the previously captured mms.
